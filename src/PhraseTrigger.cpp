...
struct PhraseTriggerWidget : ModuleWidget {
	...
	//	addInput(Port::create<PJ301MPort>(Vec(33, 186), Port::INPUT, module, PhraseTrigger::PITCH_INPUT));

	//	addOutput(Port::create<PJ301MPort>(Vec(33, 275), Port::OUTPUT, module, PhraseTrigger::SINE_OUTPUT));
...
Model *modelPhraseTrigger = Model::create<PhraseTrigger, PhraseTriggerWidget>("CompuGlobalHyperMegaNet", "PhraseTrigger", "Phrase Trigger", SEQUENCER_TAG);